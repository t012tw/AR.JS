...
function initAH() {
	...
	var cy = new THREE.Mesh(new THREE.CylinderGeometry(0.55, 0.55, 2, 32, 2, false), new THREE.MeshBasicMaterial({
	map: backTex,
	side: THREE.BackSide
	}))
	meshobjA.add(cy);
	...
	var mid1A = new THREE.Mesh (buildside1A(), materialA);
	mid1A.position.set(0,17.75,1.05);
	var mid2A = mid1A.clone();
	mid2A.position.set(0,17.75,-1.05);
	
	var mid3A = new THREE.Mesh (buildside2A(), materialA);
